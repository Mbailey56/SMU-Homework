...
def welcome():
    return (
        ...
        <a href='/api/v1.0/precipitation'>/api/v1.0/stations</a>
        <a href='/api/v1.0/precipitation'>/api/v1.0/<start</a>
        <a href='/api/v1.0/precipitation'>/api/v1.0/<start>/<end></a>
        <a href='/api/v1.0/precipitation'>/api/v1.0/tobs</a>
        """
    )
